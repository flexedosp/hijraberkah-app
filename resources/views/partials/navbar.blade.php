<nav class="lg:px-20 px-4 py-3">
    <div class="flex items-center">
        <div class="lg:flex-initial flex-1 text-center">
            <a href="/" class="lg:block hidden"><img class="w-20 h-auto" src="/img/Logo.png" alt=""></a>
            <div class="lg:hidden block">
                <a href="/" class=" flex justify-center"><img class="w-[200px] h-auto my-2" src="/img/Logo_Landscape.png" alt=""></a>
            </div>
        </div>
